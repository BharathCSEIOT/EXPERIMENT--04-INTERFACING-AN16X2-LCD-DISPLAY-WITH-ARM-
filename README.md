...
MX_GPIO_Init();
  ...
  Lcd_cursor(&lcd,1,0);
  Lcd_string(&lcd,"K BHARATH");
```


## Output screen shots of proteus  :
 ![image](https://github.com/BharathCSEIOT/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/122793480/135dcb39-6327-4f19-830d-c636b8522dbf)
